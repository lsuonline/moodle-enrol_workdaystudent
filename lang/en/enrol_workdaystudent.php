...
$string['workdaystudent_username_desc'] = 'Username supplied by the webservice creator.';
$string['workdaystudent_password'] = 'Password';
$string['workdaystudent_password_desc'] = 'Password supplied by the webservice creator.';

// Basic Config.
$string['workdaystudent_apiversion'] = 'API Version';
$string['workdaystudent_apiversion_desc'] = 'Workday Student API version.';
$string['workdaystudent_campus'] = 'Campus Code';
$string['workdaystudent_campus_desc'] = 'Campus code supplied by Workday Student contact.';
$string['workdaystudent_campusname'] = 'Campus Name';
$string['workdaystudent_campusname_desc'] = 'Campus name supplied by Workday Student contact.';
$string['workdaystudent_brange'] = 'Date Range';
$string['workdaystudent_brange_desc'] = 'Number of days ahead for grabbing future semesters.';
$string['workdaystudent_erange'] = 'Date Range';
$string['workdaystudent_erange_desc'] = 'Number of days behind for grabbing past semesters.';
$string['workdaystudent_metafields'] = 'Meta Fields';
$string['workdaystudent_metafields_desc'] = 'Comma separated list of meta fields to fetch.';
$string['workdaystudent_sportfield'] = 'Sport Field';
$string['workdaystudent_sportfield_desc'] = 'Sport field designator.';
$string['workdaystudent_studentrole'] = 'Student Role';
$string['workdaystudent_studentrole_desc'] = 'The role you want to use for students in the student courses.';
$string['workdaystudent_suspend_unenroll'] = 'Unenroll or Suspend';
$string['workdaystudent_suspend_unenroll_desc'] = 'Unenroll or suspend students.';
$string['workdaystudent_contacts'] = 'Email Contacts';
$string['workdaystudent_contacts_desc'] = 'Comma separated list of Moodle usernames you wish to email statuses and errors.';

// Webservice URL and endpoint suffixes.
$string['workdaystudent_wsurl'] = 'Webservice Endpoint';
$string['workdaystudent_wsurl_desc'] = 'Base URL for the webservice endpoint.';
$string['workdaystudent_units'] = 'Units Endpoint';
$string['workdaystudent_units_desc'] = 'URL suffix for the academic units endpoint.';
$string['workdaystudent_periods'] = 'Periods Endpoint';
$string['workdaystudent_periods_desc'] = 'URL suffix for the academic periods endpoint.';
$string['workdaystudent_programs'] = 'Programs Endpoint';
$string['workdaystudent_programs_desc'] = 'URL suffix for the programs of study endpoint.';
$string['workdaystudent_grading_schemes'] = 'Grading Schemes Endpoint';
$string['workdaystudent_grading_schemes_desc'] = 'URL suffix for the grading schemes endpoint.';
$string['workdaystudent_courses'] = 'Courses Endpoint';
$string['workdaystudent_courses_desc'] = 'URL suffix for the courses endpoint.';
$string['workdaystudent_sections'] = 'Sections Endpoint';
$string['workdaystudent_sections_desc'] = 'URL suffix for the course sections endpoint.';
$string['workdaystudent_dates'] = 'Dates Endpoint';
$string['workdaystudent_dates_desc'] = 'URL suffix for the academic dates endpoint.';
$string['workdaystudent_students'] = 'Students Endpoint';
$string['workdaystudent_students_desc'] = 'URL suffix for the students endpoint.';
$string['workdaystudent_registrations'] = 'Registrations Endpoint';
$string['workdaystudent_registrations_desc'] = 'URL suffix for the student section registrations endpoint.';
$string['workdaystudent_guild'] = 'GUILD Endpoint';
$string['workdaystudent_guild_desc'] = 'URL suffix for the GUILD associations endpoint.';
